...
import { checkProfileUsernameAvailability, claimUsernmae } from '@/modules/profile/actions'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try {
      ...
      if(linkValue.trim() && isAvailable){
        setIsClaiming(true);
        const result = await claimUsernmae(linkValue);
        if(result.success){
      ...
      toast.error("failled to claim link, please try again.");
